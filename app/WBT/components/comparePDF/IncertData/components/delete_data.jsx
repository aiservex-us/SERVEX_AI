...
const DeleteTenantButton = ({ targetTableName, currentTenant, onDeleted }) => {
  ...
  const handleDelete = async () => {
    if (!targetTableName || !currentTenant) {
      alert('Error de configuración: Faltan datos necesarios para la eliminación.');
      return;
    }
    ...
    try {
      // Usamos .delete() y verificamos el resultado
      ...
      if (count === 0) {
        alert(`No se encontró ningún registro con company_name: "${cleanTenant}". Verifica que el valor sea exacto.`);
      } else {
    ...
    <div className="w-full space-y-3">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <p className="text-[11px] text-gray-500 leading-relaxed">
          Se borrará permanentemente toda la información asociada a este tenant. Esta operación es irreversible.
        </p>
      </div>
