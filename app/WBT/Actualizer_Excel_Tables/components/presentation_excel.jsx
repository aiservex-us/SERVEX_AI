    ...
    <div className="relative h-[94vh] w-full font-sans overflow-hidden bg-white flex">
      ...
      <div className="w-full lg:w-[65%] h-full bg-white flex flex-col justify-center items-center p-8 sm:p-12 lg:p-20">
        ...
        <div className="max-w-3xl w-full flex flex-col items-center text-center">
          ...
          {/* Hero Content */}
          <div className="flex flex-col items-center">
            <div className="inline-flex items-center gap-2 mb-8 rounded-full border border-[#2563eb]/20 bg-[#2563eb]/5 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-[#2563eb]">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-black/30">
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#2563eb]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                  Data Control
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#2563eb]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
      ...
      {/* --- LADO DERECHO (VISUAL) --- */}
      <div className="hidden lg:flex w-[35%] h-full relative items-center justify-center overflow-hidden border-l border-gray-100 bg-gradient-to-b from-[#2563eb]/40 via-[#2563eb]/10 to-white">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center" style={{ perspective: '1200px' }}>
          ...
          {/* Coin 1: Back left */}
          <div
            className="absolute top-[15%] left-[5%] w-[180px] h-[180px]  bg-white/20 backdrop-blur-md border border-white/50"
            style={{
          ...
          <div
            className="absolute top-[20%] left-[20%] w-[200px] h-[200px]  bg-gradient-to-br from-[#2563eb]/60 to-[#2563eb]/20 backdrop-blur-xl border border-white/60 z-10"
            style={{
          ...
          <div
            className="absolute top-[30%] right-[25%] w-[160px] h-[160px]  bg-white/30 backdrop-blur-md border border-white/50 z-10"
            style={{
          ...
          {/* Coin 4: Middle right */}
          <div
            className="absolute bottom-[35%] right-[10%] w-[190px] h-[190px]  bg-white/40 backdrop-blur-lg border border-white/70"
            style={{
          ...
          <div
            className="absolute bottom-[20%] left-[25%] w-[180px] h-[180px]  bg-[#2563eb]/20 backdrop-blur-xl border border-white/30 blur-[4px]"
            style={{
        ...
        <div className="absolute top-12 right-12 cursor-pointer group z-20">
          <div className="w-6 h-[1.5px] bg-[#2563eb] mb-1.5 transition-all group-hover:w-8" />
          <div className="w-4 h-[1.5px] bg-[#2563eb] ml-auto" />
        </div>
