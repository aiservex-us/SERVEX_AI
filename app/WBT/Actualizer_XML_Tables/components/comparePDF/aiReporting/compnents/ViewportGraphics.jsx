  ...
  return (
    <main className="flex-1 flex flex-col relative bg-[#FAFAFA] h-[100%] font-sans overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pb-[180px] p-6 relative">
        ...
        {/* === SECCIÓN DE GRÁFICAS (Mantenida intacta) === */}
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <CardContainer colSpan={1} title="Trayectoria de Anomalías" explanation="Rastrea la evolución entre precios. Las separaciones pronunciadas entre líneas alertan sobre posibles errores.">
              <ResponsiveContainer width="100%" height="100%">
