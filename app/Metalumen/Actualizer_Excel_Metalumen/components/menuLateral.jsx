...
const menuItems = [
  { id: 'reporting', label: 'Metalumen Home', icon: LayoutDashboard, sub: 'Dashboard' },
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/Metalumen/Actualizer_XML_Metalumen' }
];
