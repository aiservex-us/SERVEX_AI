...
const menuItems = [
  { id: 'reporting', label: 'Header Group Home', icon: LayoutDashboard, sub: 'Dashboard' },
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/Header_Group/Actualizer_XML_Header_Group' }
];
