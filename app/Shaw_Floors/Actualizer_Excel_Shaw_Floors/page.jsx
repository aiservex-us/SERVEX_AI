...
import XMLResultsShaw Floors from './components/XML_Results_Shaw_Floors.jsx';
import CETComparator from './components/CET_Comparator.jsx';
import CSVFinalResultsShaw Floors from './components/CSV_Final_Results_Shaw_Floors.jsx';
...
export default function ExcelActualizer() {
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'csv_final': return <CSVFinalResultsShaw Floors />;
