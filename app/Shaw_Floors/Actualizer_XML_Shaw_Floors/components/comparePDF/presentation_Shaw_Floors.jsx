        ...
        <div className="max-w-3xl w-full flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="max-w-xl text-base sm:text-lg text-black/50 leading-relaxed mb-12 font-light">
              ...
              and real-time updates for Shaw Floors product catalogs within the <span className="text-black/80 font-medium">SERVEX ecosystem</span>.
            </p>
