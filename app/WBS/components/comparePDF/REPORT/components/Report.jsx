...
export default function AuditReportViewer() {
  ...
  useEffect(() => {
    async function fetchAuditData() {
      setLoading(true);
      // Ajuste: Se usan comillas dobles para forzar el nombre de la columna con la 'P' mayúscula
          ...
          <div className="bg-[#FDFDFD] border-b border-[#E0E0E0] p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#242424]">Procesamiento de fuentes {reportData?.source_format || 'XML/CSV'}. Integridad validada.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#242424]">Detección mediante modelos SERVEX_AI.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#242424]">Ejecución: {reportData?.execution_time || '0.4s'}. Estado: <span className="font-bold text-[#107C10]">OPTIMIZADO</span></p>
              </div>
            </div>
          </div>
