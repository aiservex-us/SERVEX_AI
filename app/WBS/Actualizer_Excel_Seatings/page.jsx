...
import TeamsAgentChat from '../Actualizer_XML_Seatings/components/comparePDF/REPORT/components/AI_contact.jsx';
  ...
  useEffect(() => {
    const checkDelegation = async () => {
      try {
        ...
        const res = await fetch(`apiURL/api/v1/module_delegation/WBS`.replace('apiURL', apiURL));
