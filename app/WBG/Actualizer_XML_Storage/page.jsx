'use client';
import XMLResultsWBG from '../Actualizer_Excel_Storage/components/XML_Results_WBG.jsx';
import ImportCETXml from '../Actualizer_Excel_Storage/components/IncertDataExcel/incertXML_excel';
import CETComparator from '../Actualizer_Excel_Storage/components/CET_Comparator.jsx';
  ...
  const renderContent = () => {
    ...
    switch (active) {
      case 'dashboard': return <Dashboard />;
                    ...
                    case 'incert_wbg_csv_base': return <IncertDelete step="csv_base" />;
                    case 'incert_wbg_csv_new': return <IncertDelete step="csv_new" />;
                    case 'import_cet_xml': return <div className="w-full h-full overflow-y-auto"><ImportCETXml moduleName="WBG" /></div>;
                    case 'exportCETcsv': return <XMLResultsWBG />;
                    case 'compareCET': return <CETComparator />;
                    case 'xml_results': return <XMLResultsWBG />;
