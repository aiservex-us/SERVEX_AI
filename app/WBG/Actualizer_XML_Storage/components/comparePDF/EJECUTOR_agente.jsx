            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              <div className="px-10 py-8">
                ...
                <div className="mb-8 pb-5 border-b border-gray-100">
                  ...
                  <p className="text-xs text-gray-400 font-medium">Generated by Servex Copilot Intelligence · Servex US</p>
                </div>
                ...
                <div className="mt-10 pt-5 border-t border-gray-100 flex items-center justify-between">
                  <span className="text-[10px] text-gray-300 font-medium uppercase tracking-widest">Servex Copilot · Confidential</span>
