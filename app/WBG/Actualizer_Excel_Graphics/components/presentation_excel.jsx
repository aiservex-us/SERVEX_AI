    ...
    <div className="relative h-[94vh] w-full font-sans overflow-hidden bg-white flex">
      ...
      <div className="w-full lg:w-[65%] h-full bg-white flex flex-col justify-center items-center p-8 sm:p-12 lg:p-20">
        ...
        <div className="max-w-3xl w-full flex flex-col items-center text-center">
          ...
          {/* Hero Content */}
          <div className="flex flex-col items-center">
            <div className="inline-flex items-center gap-2 mb-8 rounded-full border border-[#7e22ce]/20 bg-[#7e22ce]/5 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-[#7e22ce]">
              <span className="w-1.5 h-1.5 rounded-full bg-[#7e22ce] animate-pulse" />
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-black/30">
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#7e22ce]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                  Data Control
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#7e22ce]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
      ...
      {/* --- LADO DERECHO (VISUAL) --- */}
      <div className="hidden lg:flex w-[35%] h-full relative items-center justify-center overflow-hidden border-l border-gray-100 bg-gradient-to-b from-[#7e22ce]/40 via-[#7e22ce]/10 to-white">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center" style={{ perspective: '1200px', filter: 'drop-shadow(0 25px 35px rgba(0,0,0,0.15)) drop-shadow(0 5px 15px rgba(0,0,0,0.05))' }}>
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #7e22ce33, rgba(255,255,255,0.1))',
          ...
          <div
            className="absolute top-[20%] left-[20%] w-[200px] h-[200px] bg-gradient-to-br from-[#7e22ce]/80 to-[#581c87]/40 backdrop-blur-xl z-10"
            style={{
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(45deg, rgba(255,255,255,0.3), #7e22ce1A)',
        ...
        <div className="absolute top-12 right-12 cursor-pointer group z-20">
          <div className="w-6 h-[1.5px] bg-[#7e22ce] mb-1.5 transition-all group-hover:w-8" />
          <div className="w-4 h-[1.5px] bg-[#7e22ce] ml-auto" />
        </div>

        <div className="relative z-20 rotate-90 pointer-events-none opacity-30 mix-blend-multiply">
          <span className="text-[#7e22ce] font-black text-[120px] tracking-tighter select-none leading-none">
            WB Storage
          </span>
        </div>
      </div>
