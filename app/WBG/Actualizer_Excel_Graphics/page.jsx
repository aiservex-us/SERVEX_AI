...
import XMLResultsWBG from './components/XML_Results_WBG.jsx';
...
export default function ExcelActualizer() {
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'incert_delete': return <IncertData moduleName="WBG" />;
  ...
  return (
    <div className="h-[97vh] w-[99%] bg-[#fff] font-sans flex items-center justify-center relative">
      <CriticalExcelModal xmlRoute="/WBG/Actualizer_XML_Graphics" />
