          ...
          >
            <div className="sticky top-0 h-[91vh] w-full flex items-center justify-center bg-white/95 rounded-xl p-6">
              ...
              <div className={`
                ...
                transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] overflow-hidden relative pointer-events-auto
                ${isAiActive ? 'translate-y-0 scale-100 opacity-100' : 'translate-y-12 scale-95 opacity-0'}
              `}>
