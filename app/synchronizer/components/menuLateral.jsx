  ...
  return (
    <aside
      ...
      className={`
        ...
        ${isEffectivelyCollapsed ? 'w-[68px]' : 'w-[250px]'}
      `}
    >
      {/* HEADER: LOGO & TOGGLE */}
      <div className="h-20 flex items-center px-4 shrink-0 relative">
        ...
        <button
          onClick={() => setCollapsed(!isEffectivelyCollapsed)}
        ...
        >
          <ChevronLeft className={`w-3 h-3 transition-transform duration-500 ${isEffectivelyCollapsed ? 'rotate-180' : ''}`} />
        </button>
      </div>
      ...
      <div className="px-3 mb-4">
        <div className={`
          ...
          ${isEffectivelyCollapsed ? 'justify-center h-10' : 'h-9 bg-slate-50/50 border border-slate-100 rounded-lg px-2 focus-within:bg-white focus-within:ring-2 focus-within:ring-[#6264A7]/10 focus-within:border-[#6264A7]/30'}
        `}>
          <Search className={`shrink-0 transition-colors ${searchQuery ? 'text-[#6264A7]' : 'text-slate-400'} ${isEffectivelyCollapsed ? 'w-5 h-5' : 'w-3.5 h-3.5'}`} />
          ...
          {!isEffectivelyCollapsed && searchQuery && (
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isEffectivelyCollapsed ? 'justify-center h-11' : 'px-3 py-2'}
                ${isActive 
