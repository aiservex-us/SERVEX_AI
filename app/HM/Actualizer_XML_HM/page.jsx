...
import AIReporting from './components/comparePDF/presentation_HM.jsx'
...
import CETComparator from '../Actualizer_Excel_HM/components/CET_Comparator.jsx';
              ...
              <TeamsAgentChat 
                ...
                renderTool={(toolId) => {
                  switch (toolId) {
                    ...
                    case 'incert_wbs_csv_base': return <IncertDelete step="csv_base" />;
                    case 'incert_wbs_csv_new': return <IncertDelete step="csv_new" />;
                    case 'import_cet_xml': return <div className="w-full h-full overflow-y-auto"><ImportCETXml moduleName="H&M" /></div>;
