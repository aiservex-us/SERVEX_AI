...
import XMLResultsH&M from './components/XML_Results_HM.jsx';
import CETComparator from './components/CET_Comparator.jsx';
import CSVFinalResultsH&M from './components/CSV_Final_Results_HM.jsx';
...
export default function ExcelActualizer() {
  ...
  useEffect(() => {
    const checkDelegation = async () => {
      try {
        ...
        const res = await fetch(`${apiURL}/api/v1/module_delegation/H&M`);
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'incert_delete': return <IncertData moduleName="H&M" />;
      case 'xml_results': return <XMLResultsH&M />;
      case 'cet_comparator': return <CETComparator />;
      case 'csv_final': return <CSVFinalResultsH&M />;
  ...
  return (
    <div className="h-[97vh] w-[99%] bg-[#fff] font-sans flex items-center justify-center relative">
      <CriticalExcelModal xmlRoute="/HM/Actualizer_XML_HM" />
            ...
            <div className="px-8 py-6 flex gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#616161] leading-relaxed">
                  You are about to leave the H&M management area. Any temporary changes in this view will be closed.
                </p>
              </div>
            </div>
