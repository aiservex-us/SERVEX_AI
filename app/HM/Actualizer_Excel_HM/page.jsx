...
import XMLResults_HM from './components/XML_Results_HM.jsx';
import CETComparator from './components/CET_Comparator.jsx';
import CSVFinalResults_HM from './components/CSV_Final_Results_HM.jsx';
...
export default function ExcelActualizer() {
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'csv_final': return <CSVFinalResults_HM />;
