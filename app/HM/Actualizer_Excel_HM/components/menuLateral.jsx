...
const menuItems = [
  { id: 'reporting', label: 'H&M Home', icon: LayoutDashboard, sub: 'Dashboard' },
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/HM/Actualizer_XML_HM' }
];
