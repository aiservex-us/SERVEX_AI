                          ...
                          {WBO_HEADERS.map((header) => {
                            ...
                            return (
                              <td key={header} className={`p-0 text-slate-800 border-r border-b border-slate-50 min-w-[160px] max-w-[280px]`}>
                                <div className={`px-3 py-1.5 font-sans text-[11px] whitespace-nowrap truncate ${header === 'Model #' || header === '2026 List Price' ? 'font-bold font-mono text-[#464775]' : 'font-medium'}`} title={value}>
                                  {value}
                                </div>
                              </td>
                            );
