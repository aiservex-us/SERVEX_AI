...
import CSVFinalResultsWBO from './components/CSV_Final_Results_WBO.jsx';
...
export default function ExcelActualizer() {
  ...
  useEffect(() => {
    const checkDelegation = async () => {
      try {
        ...
        const res = await fetch(`apiURL/api/v1/module_delegation/WBO`.replace('apiURL', apiURL));
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'csv_final_results': return <CSVFinalResultsWBO />;
  ...
  return (
    <div className="h-[97vh] w-[99%] bg-[#fff] font-sans flex items-center justify-center relative">
      <CriticalExcelModal xmlRoute="/WBO/Actualizer_XML_Workstations" />
            ...
            <div className="px-8 py-6 flex gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#616161] leading-relaxed">
                  You are about to leave the WBO management area. Any temporary changes in this view will be closed.
                </p>
              </div>
            </div>
