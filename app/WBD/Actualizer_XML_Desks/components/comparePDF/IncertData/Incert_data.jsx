...
const IncertData = () => {
  ...
  return (
    <div className="relative p-8 max-w-8xl mx-auto space-y-8 font-sans">
      
      {/* Overlay del Logo e Information (Card) */}
      <div
        className={`hidden min-[400px]:block fixed inset-0 z-[100] pointer-events-none transition-all duration-500 ease-out ${showOverlay ? 'opacity-100 backdrop-blur-[2px]' : 'opacity-0'
          }`}
      >
