...
export default function ExcelActualizer() {
  ...
  useEffect(() => {
    const checkDelegation = async () => {
      try {
        ...
        const res = await fetch(`apiURL/api/v1/module_delegation/WBD`.replace('apiURL', apiURL));
  ...
  return (
    <div className="h-[97vh] w-[99%] bg-[#fff] font-sans flex items-center justify-center relative">
      <CriticalExcelModal xmlRoute="/WBD/Actualizer_XML_Desks" />
            ...
            <div className="px-8 py-6 flex gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#616161] leading-relaxed">
                  You are about to leave the WBD management area. Any temporary changes in this view will be closed.
                </p>
              </div>
            </div>
