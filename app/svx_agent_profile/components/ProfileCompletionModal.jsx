...
export default function ProfileCompletionModal({ currentUser, onComplete }) {
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        // En una app real de prod se debe redimensionar con Canvas, pero para simplicidad usamos Base64 directo
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { error } = await supabase
        .from('AI_Users')
        .update({ user_personal_data_complete: completeData })
      ...
      console.error(e);
      setErrorMsg('Error guardando los datos del perfil.');
    }
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="px-5 py-4 bg-gray-50/80 backdrop-blur-md border border-gray-100 rounded-2xl rounded-tl-sm shadow-sm w-full">
                  <p className="text-gray-700 text-[13.5px] leading-relaxed m-0">
                    Veo que tu perfil aún no está completo. Necesitamos un poco más de información (foto, descripción, etc.) para que todo quede perfecto.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="px-5 py-4 bg-gray-50/80 backdrop-blur-md border border-gray-100 rounded-2xl rounded-tl-sm shadow-sm w-full">
                  <p className="text-gray-700 text-[13.5px] leading-relaxed mb-4">
                    Primero, <strong>sube una foto de perfil</strong>.
                  </p>
          ...
          <motion.div key="step-2" {...animationProps} className="flex-1 flex flex-col justify-center max-w-sm w-full mx-auto">
            <div className="flex gap-4 items-start mb-6">
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="px-5 py-4 bg-gray-50/80 backdrop-blur-md border border-gray-100 rounded-2xl rounded-tl-sm shadow-sm w-full">
                  <p className="text-gray-700 text-[13.5px] leading-relaxed mb-4">
                    Excelente. Ahora, escribe una <strong>breve descripción tuya</strong> (About Me) para que tus colegas conozcan un poco más sobre ti.
                  </p>
            ...
            <div className="flex justify-end gap-2">
              ...
              <button 
                onClick={() => descripcion.trim() && setChatStep(3)}
          ...
          <motion.div key="step-3" {...animationProps} className="flex-1 flex flex-col justify-center max-w-sm w-full mx-auto">
            <div className="flex gap-4 items-start mb-6">
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="px-5 py-4 bg-gray-50/80 backdrop-blur-md border border-gray-100 rounded-2xl rounded-tl-sm shadow-sm w-full">
                  <p className="text-gray-700 text-[13.5px] leading-relaxed mb-4">
                    Por último, por favor confirma tu <strong>teléfono y ubicación</strong>.
                  </p>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4 overflow-hidden">
      <motion.div
        initial={{ opacity: 0, scale: 0.97 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.4 }}
        className="w-full max-w-5xl h-[70vh] max-h-[800px] bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 relative"
      >
        {/* Lado Izquierdo */}
        <div className="relative hidden md:flex flex-col justify-end p-10 overflow-hidden bg-gradient-to-br from-[#464775]/40 via-[#464775]/10 to-white">
          ...
          <div className="relative z-10 text-[#2B2C4B]">
            ...
            <h2 className="text-2xl font-semibold leading-snug">
              Completemos tu Perfil de Usuario Corporativo.
            </h2>
          </div>
        </div>
