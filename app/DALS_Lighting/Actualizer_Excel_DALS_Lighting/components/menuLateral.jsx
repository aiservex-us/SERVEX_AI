...
const menuItems = [
  { id: 'reporting', label: 'DALS Lighting Home', icon: LayoutDashboard, sub: 'Dashboard' },
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/DALS_Lighting/Actualizer_XML_DALS_Lighting' }
];
      ...
      >
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isEffectivelyCollapsed ? 'items-center justify-center py-3' : 'p-3'}
                  ${isActive
        ...
        <div className="p-3 border-t border-slate-50 bg-white/50 space-y-2">
          ...
          <div className={`
            ...
            ${isEffectivelyCollapsed ? 'justify-center h-10' : 'p-2 bg-[#464775] text-white shadow-lg shadow-[#464775]/20'}
          `}>
