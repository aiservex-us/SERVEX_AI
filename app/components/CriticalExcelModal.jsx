...
export default function CriticalExcelModal({ xmlRoute, moduleName = 'default' }) {
  ...
  const getTheme = (mod) => {
    switch(mod) {
      case 'WBO': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { borderRadius: '9999px' } };
      case 'WBT': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { clipPath: 'polygon(50% 0%, 93% 25%, 93% 75%, 50% 100%, 7% 75%, 7% 25%)' } };
      case 'WBD': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' } };
      case 'WBS': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { clipPath: 'polygon(50% 0%, 100% 38%, 81% 100%, 19% 100%, 0% 38%)' } };
      case 'WBA': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { clipPath: 'polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)' } };
      case 'WBG': return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)' } };
      ...
      default: return { color: '#7f1d1d', bg: 'bg-[#7f1d1d]', hover: 'hover:bg-[#450a0a]', text: 'text-[#7f1d1d]', grad: 'from-[#7f1d1d]/40 via-[#7f1d1d]/10', gradShape: 'from-[#7f1d1d]/80 to-[#450a0a]/40', shadow: 'shadow-[#7f1d1d]/30', borderHover: 'hover:border-[#7f1d1d]/30', fill: 'bg-[#7f1d1d]/15', fillAlt: 'bg-[#7f1d1d]/5', border: 'border-[#7f1d1d]/20', shape: { borderRadius: '9999px' } };
    }
  };
