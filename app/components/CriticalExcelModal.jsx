...
export default function CriticalExcelModal({ xmlRoute, moduleName = 'default' }) {
  ...
  const getTheme = (mod) => {
    switch(mod) {
      case 'WBO': return { color: '#003873', bg: 'bg-[#003873]', hover: 'hover:bg-[#002244]', text: 'text-[#003873]', grad: 'from-[#003873]/40 via-[#003873]/10', gradShape: 'from-[#003873]/80 to-[#002244]/40', shadow: 'shadow-[#003873]/30', borderHover: 'hover:border-[#003873]/30', fill: 'bg-[#003873]/15', fillAlt: 'bg-[#003873]/5', border: 'border-[#003873]/20', shape: { borderRadius: '9999px' } };
      ...
      default: return { color: '#003873', bg: 'bg-[#003873]', hover: 'hover:bg-[#002244]', text: 'text-[#003873]', grad: 'from-[#003873]/40 via-[#003873]/10', gradShape: 'from-[#003873]/80 to-[#002244]/40', shadow: 'shadow-[#003873]/30', borderHover: 'hover:border-[#003873]/30', fill: 'bg-[#003873]/15', fillAlt: 'bg-[#003873]/5', border: 'border-[#003873]/20', shape: { borderRadius: '9999px' } };
    }
  };
