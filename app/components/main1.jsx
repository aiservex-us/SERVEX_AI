...
function SimpleModal({ isOpen, onClose, title, description }) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
          className=" fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 backdrop-filter backdrop-blur-md "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.div
            className=" relative w-full max-w-lg bg-white rounded-xl shadow-2xl p-6 sm:p-8 "
          ...
          >
            ...
            <button
              onClick={onClose}
              className=" mt-6 inline-flex justify-center rounded-full bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-800 transition "
            >
              Cerrar
            </button>
          </motion.div>
...
export default function Main1() {
  ...
  return (
    <main className=" relative w-full min-h-[90%] bg-white text-black flex items-center justify-center px-3 sm:px-6 ">
      <SimpleModal
      ...
      <section className=" relative w-full max-w-[1400px] min-h-[80vh] md:h-[80vh] mx-auto rounded-[24px] bg-white overflow-hidden flex flex-col ">
        ...
        <div className=" flex-1 grid grid-cols-1 md:grid-cols-2 gap-10 px-4 sm:px-6 md:px-10 pb-6 md:pb-10 items-center ">
          {/* Left content */}
          <div>
            <span className=" relative inline-block top-[-20px] mb-5 rounded-full border border-black/10 px-4 py-1 text-[11px] sm:text-xs ">
            ...
            <p className=" mt-5 sm:mt-6 max-w-md text-sm text-black/60 ">
            ...
            <div className=" mt-7 sm:mt-8 flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-6 ">
              ...
              <a
                ...
                className=" inline-flex items-center justify-center w-full sm:w-auto rounded-full bg-black px-8 py-3 text-sm font-medium text-white shadow-lg transition hover:scale-[1.03] "
              >
                Go to SERVEX
              </a>
