  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (csvNewContent.trim()) {
        payload.csv_new_raw = csvNewContent;
      }
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-[#242424]">LESRO Catalog Upload</h1>
        ...
        <div className="bg-[#464775]/10 border-b border-[#464775]/20 px-8 py-3">
          <p className="text-[11px] text-[#464775] leading-relaxed max-w-4xl">
            ...
            <span className="font-bold">LESRO</span> corresponding to the LESRO catalogs of this entity.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[11px] text-[#616161] leading-relaxed ml-9">
                    This is the catalog generated by Catalog Creator. It represents the final/structured version of the catalog.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[11px] text-[#616161] leading-relaxed ml-9">
                    This is the base catalog that starts the process: the step before the last one, prior to generating the final XML.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-[#464775]">CSV — New Catalog</span>
                  </div>
                  <p className="text-[11px] text-[#616161] leading-relaxed ml-9">
                    This is the new or updated catalog that will be compared against the base.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="px-6 py-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <p className="text-[8px] text-[#9CA3AF] mt-0.5">Catalog Creator Catalog</p>
                    {showXmlExistingNotice && (
                  ...
                  >
                    ...
                    <p className="text-[8px] text-[#9CA3AF] mt-0.5">New catalog to compare</p>
                    {showNewCsvExistingNotice && (
                      <p className="text-[9px] text-[#464775]/80 mt-1 font-medium">Click or drop to replace</p>
                    )}
