...
const menuItems = [
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/LESRO/Actualizer_XML_LESRO' }
];
    ...
    <>
      ...
      >
        ...
        <div className="px-3 mb-4">
          ...
          `}>
            <SearchCode className={`shrink-0 transition-colors ${searchQuery ? 'text-[#003873]' : 'text-slate-400'} ${isEffectivelyCollapsed ? 'w-4 h-4' : 'w-3.5 h-3.5'}`} />
