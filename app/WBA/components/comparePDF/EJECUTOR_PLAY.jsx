...
const EJECUTOR_PLAY = ({ 
  ...
  const ejecutarSegundoProceso = async () => {
    ...
    try {
      // SANEAMIENTO MULTI-TENANT: Forzamos la identificación limpia de WBA para este sub-motor
      ...
      // SOLUCIÓN AL 404: Endpoint modificado con el sufijo -WBA mapeado en el backend
      ...
      console.error(`Secondary Process halted (WBA): ${err.message}`);
    } finally {
