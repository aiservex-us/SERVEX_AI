...
import XMLResultsWBA from './components/XML_Results_WBA.jsx';
...
export default function ExcelActualizer() {
  ...
  useEffect(() => {
    const checkDelegation = async () => {
      try {
        ...
        const res = await fetch(`apiURL/api/v1/module_delegation/WBA`.replace('apiURL', apiURL));
  ...
  const renderContent = () => {
    switch (active) {
      ...
      case 'incert_delete': return <IncertData moduleName="WBA" />;
  ...
  return (
    <div className="h-[97vh] w-[99%] bg-[#fff] font-sans flex items-center justify-center relative">
      <CriticalExcelModal xmlRoute="/WBA/Actualizer_XML_Accessories" />
            ...
            <div className="px-8 py-6 flex gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#616161] leading-relaxed">
                  You are about to leave the WBA management area. Any temporary changes in this view will be closed.
                </p>
              </div>
            </div>
