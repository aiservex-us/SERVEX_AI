    ...
    <div className="relative h-[94vh] w-full font-sans overflow-hidden bg-white flex">
      ...
      <div className="w-full lg:w-[65%] h-full bg-white flex flex-col justify-center items-center p-8 sm:p-12 lg:p-20">
        ...
        <div className="max-w-3xl w-full flex flex-col items-center text-center">
          ...
          {/* Hero Content */}
          <div className="flex flex-col items-center">
            <div className="inline-flex items-center gap-2 mb-8 rounded-full border border-[#b45309]/20 bg-[#b45309]/5 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-[#b45309]">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-black/30">
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#b45309]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg>
                  1-Click Export
                </span>
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#b45309]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg>
      ...
      {/* --- LADO DERECHO (VISUAL) --- */}
      <div className="hidden lg:flex w-[35%] h-full relative items-center justify-center overflow-hidden border-l border-gray-100 bg-gradient-to-b from-[#b45309]/40 via-[#b45309]/10 to-white">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center" style={{ perspective: '1200px', filter: 'drop-shadow(0 25px 35px rgba(0,0,0,0.15)) drop-shadow(0 5px 15px rgba(0,0,0,0.05))' }}>
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #b4530933, rgba(255,255,255,0.1))',
          ...
          <div
            className="absolute top-[20%] left-[20%] w-[200px] h-[200px] bg-gradient-to-br from-[#b45309]/80 to-[#78350f]/40 backdrop-blur-xl z-10"
            style={{
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(45deg, rgba(255,255,255,0.3), #b453091A)',
        ...
        <div className="absolute top-12 right-12 cursor-pointer group z-20">
          <div className="w-6 h-[1.5px] bg-[#b45309] mb-1.5 transition-all group-hover:w-8" />
          <div className="w-4 h-[1.5px] bg-[#b45309] ml-auto" />
        </div>
        
        <div className="relative z-20 rotate-90 pointer-events-none opacity-30 mix-blend-multiply">
          <span className="text-[#b45309] font-black text-[120px] tracking-tighter select-none leading-none">
            WB Seating
          </span>
        </div>
      </div>
