...
const menuItems = [
  { id: 'reporting', label: 'MityLite Home', icon: LayoutDashboard, sub: 'Dashboard' },
  ...
  { id: 'xml_redirect', label: 'Ejecutar Actualizacion de XML inicial!!', icon: RefreshCcw, sub: 'Action', link: '/MityLite/Actualizer_XML_MityLite' }
];
