...
for f_path in files:
    if os.path.exists(f_path):
        ...
        content = content.replace(new_card_classes, original_card_classes)

        # Revert decorative blobs
        ...
        content = content.replace(new_blobs, old_blobs)

        with open(f_path, 'w') as f:
            f.write(content)
            
print("Reverted card styling in all dashboard.jsx files.")
