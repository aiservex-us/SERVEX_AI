...
for mod in modules:
    ...
    page_content = re.sub(r"case 'incert_delete': return <IncertData moduleName=\s*\n", f"case 'incert_delete': return <IncertData moduleName=\"{mod_id}\" />;\n", page_content)
    
    with open(page_path, "w") as f:
        f.write(page_content)
        
    print(f"Fixed moduleName in {mod_id}")
