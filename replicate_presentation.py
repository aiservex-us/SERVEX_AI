...
files = [
    ...
    "/Users/glynne/Desktop/SERVEX_AI/app/WBT/Actualizer_XML_Tables/components/comparePDF/presentation_WBT.jsx",
...
for f_path in files:
    if os.path.exists(f_path):
        ...
        match = re.search(r'span className="text-white font-black text-\[100px\][^>]+>\s*(.*?)\s*</span>', content)
        if match:
